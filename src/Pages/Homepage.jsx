   ...
   <footer className="bg-black text-white py-8">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center border-b border-gray-700 pb-8 mb-8">
            <h2 className="text-xl font-bold">Find your best opportunities today!</h2>
            <div className="mt-4 md:mt-0">
              <button className="bg-white text-black py-3 px-6 rounded mr-4 hover:bg-gray-200">
                Explore Jobs
              </button>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center text-gray-400">
            ...
            <div className="mb-4 md:mb-0">
              <p className="text-gray-400">Write us: <a href="mailto:support@jobscout.com" className="text-white">support@jobscout.com</a></p>
            </div>

            <div>
              <p>Call us: <a href="tel:02012345678" className="text-white">020 123 4567 890</a></p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-between items-center mt-8">
            ...
            <div className="flex space-x-6 text-gray-400">
              <a href="#" className="hover:text-white">Find Job</a>
              <a href="#" className="hover:text-white">Hiring</a>
